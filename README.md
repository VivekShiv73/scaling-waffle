...
path to the file
a word or a phrase
The program will read the contents in the file and search for occurrences of the search phrase in the file. The program should then replace all characters of matching occurrences of the search phrase with #.
